  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalHistoricoMovimientosLabel"><i class="fas fa-history"></i> Histórico de Movimientos</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
          <table class="table table-bordered table-sm mb-0" id="tablaHistoricoMovimientos">
...
<!-- La función cargarHistoricoMovimientos está definida en functions_inventario.js -->