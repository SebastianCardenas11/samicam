...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="app-header__logo" href="<?= base_url(); ?>/dashboard" style="display: flex; align-items: center;">
            <img src="<?= base_url(); ?>/Assets/images/samicam.png" alt="SAMICAM Logo"
                style="height: 81px;
            margin-left: -34px;">
        </a>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url(); ?>/funcionariosPermisos">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url(); ?>/">
                    ...
                    <span class="nav-link-text ms-1">TU CUENTA</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url(); ?>/">
    ...
    <div class="sidenav-footer mx-3 ">
        ...
        <a class="btn btn-info w-100 salir-btn"
            href="<?= base_url(); ?>/logout">Salir
        </a>
        ...
        <div class="container-fluid py-1 px-3">
            ...
            <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                    <!-- Se ha eliminado el bloque del buscador -->
                </div>
            </div>
        ...
        <div class="card shadow-lg ">
            ...
            <div class="card-body pt-sm-3 pt-0">
                ...
                <div class="form-check form-switch ps-0">
                    <!-- El checkbox se marcará por defecto -->
                ...
                <a class="btn btn-outline-dark w-100" href="https://www.creative-tim.com/learning-lab/bootstrap/license/soft-ui-dashboard">Ver Documentacion</a>

                <div class="w-100 text-center">

                    <h6 class="mt-3">Gracias !</h6>
                    <a href="https://twitter.com/intent/tweet?text=Check%20Soft%20UI%20Dashboard%20made%20by%20%40CreativeTim%20%23webdesign%20%23dashboard%20%23bootstrap5&amp;url=https%3A%2F%2Fwww.creative-tim.com%2Fproduct%2Fsoft-ui-dashboard" class="btn btn-dark mb-0 me-2" target="_blank">
                        <i class="fab fa-twitter me-1" aria-hidden="true"></i> Tweet
                    </a>
                    <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.creative-tim.com/product/soft-ui-dashboard" class="btn btn-dark mb-0 me-2" target="_blank">
                        <i class="fab fa-facebook-square me-1" aria-hidden="true"></i> Siguenos
                    </a>
                </div>
            </div>
        </div>
