...
try {
    ...
    $sql = "CREATE TABLE IF NOT EXISTS `tbl_equipos_movimientos` (
    ...
    $pdo->exec($sql);
    echo "Tabla tbl_equipos_movimientos creada exitosamente.<br>";
    
    // Insertar datos de ejemplo
    $insertSql = "INSERT IGNORE INTO `tbl_equipos_movimientos` (`id_equipo`, `tipo_equipo`, `tipo_movimiento`, `observacion`, `fecha_hora`, `usuario`) VALUES
    ...
    echo "Instalación completada. Puedes eliminar este archivo.";
