  ...
  request.onreadystatechange = function () {
    if (request.readyState == 4 && request.status == 200) {
      ...
      if (objData.status) {
        ...
        document.querySelector("#txtCorreoFuncionario").value = objData.data.correo_elc;
        ...
        document.querySelector("#txtFormacionFuncionario").value = objData.data.formacion_academica;
        document.querySelector("#txtNombreFormacion").value = objData.data.nombre_formacion;
